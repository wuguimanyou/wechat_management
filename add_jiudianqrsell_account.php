<?php
 ...
 require('../back_init.php');   
  ...
  $query = "select id,account_type,account from weixin_card_members where isvalid=true and user_id = ".$user_id." limit 0,1";
...
<form action="save_jiudianqrsell_account.php?customer_id=<?php echo $customer_id_en ?>"  id="keywordFrm" method="post">
	...
	<div id="products" class="r_con_wrap">
	 <div class="r_con_form" >
		...
		<div class="rows">
			<label>收款账户</label><?php echo $account ?>
			<span class="input">
